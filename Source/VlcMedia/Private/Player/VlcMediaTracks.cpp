...
void
FVlcMediaTracks::Initialize( FLibvlcMediaPlayer& InPlayer, FString& OutInfo )
{
	Shutdown();
...
bool
FVlcMediaTracks::GetAudioTrackFormat( int32 TrackIndex, int32 FormatIndex, FMediaAudioTrackFormat& OutFormat ) const
{
...
int32
FVlcMediaTracks::GetNumTracks( EMediaTrackType TrackType ) const
{
	switch ( TrackType )
	{
...
int32
FVlcMediaTracks::GetNumTrackFormats( EMediaTrackType TrackType, int32 TrackIndex ) const
{
...
int32
FVlcMediaTracks::GetSelectedTrack( EMediaTrackType TrackType ) const
{
	if ( Player == nullptr )
	{
		return INDEX_NONE;
...
FText
FVlcMediaTracks::GetTrackDisplayName( EMediaTrackType TrackType, int32 TrackIndex ) const
{
	switch ( TrackType )
	{
	case EMediaTrackType::Audio:
...
int32
FVlcMediaTracks::GetTrackFormat( EMediaTrackType TrackType, int32 TrackIndex ) const
{
...
FString
FVlcMediaTracks::GetTrackLanguage( EMediaTrackType TrackType, int32 TrackIndex ) const
{
...
FString
FVlcMediaTracks::GetTrackName( EMediaTrackType TrackType, int32 TrackIndex ) const
{
	switch ( TrackType )
	{
	case EMediaTrackType::Audio:
...
bool
FVlcMediaTracks::GetVideoTrackFormat( int32 TrackIndex, int32 FormatIndex, FMediaVideoTrackFormat& OutFormat ) const
{
...
bool
FVlcMediaTracks::SelectTrack( EMediaTrackType TrackType, int32 TrackIndex )
{
	if ( Player == nullptr )
	{
...
bool
FVlcMediaTracks::SetTrackFormat( EMediaTrackType TrackType, int32 TrackIndex, int32 FormatIndex )
{
